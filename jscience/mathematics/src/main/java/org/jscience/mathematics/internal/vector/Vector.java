...
public abstract class Vector<F extends Field<F>>
     ...
     */
    protected static final TextFormat<Vector> DEFAULT_VECTOR_FORMAT = new TextFormat<Vector>(Vector.class) {

        @Override
        public Appendable format(Vector V, Appendable out) throws IOException {
            out.append('{');
        ...
        @Override
        public Vector parse(CharSequence csq, Cursor cursor) throws IllegalArgumentException {
    ...
    public final Text toText() {
        TextFormat<Vector> textFormat = TextFormat.getInstance(this.getClass());
