 ...
 */
public class Float64Vector extends DenseVector<Float64> implements
   ...
   /**
    ...
    @Override
    public List<Float64> asList() {
        FastTable<Float64> list = FastTable.newInstance();
        for (int i=0; i < _dimension; i++) {
            list.add(Float64.valueOf(_values[i]));
        }
