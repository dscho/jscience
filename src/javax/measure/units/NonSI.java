...
import javax.measure.converters.LogConverter;
 ...
 *     and widely used.</p>
 *     
 * <p> A collection of all the NonSI units defined can be retrieved using the 
 *     {@link #units() NonSI.units()} static method.</p>
 *
...
public final class NonSI {
     ...
     */
    public static final Unit<Acceleration> G = nonSI(METER_PER_SQUARE_SECOND
     ...
     */
    public static final Unit<Area> ARE = nonSI(SQUARE_METER.times(100));
     ...
     */
    public static final Unit<Length> FOOT = nonSI(METER.times(INTERNATIONAL_FOOT_DIVIDEND).divide(INTERNATIONAL_FOOT_DIViSOR));
     ...
     */
    public static final Unit<Length> FOOT_SURVEY_US = nonSI(METER
     ...
     */
    public static final Unit<Length> MILE = nonSI(METER.times(1609344).divide(1000));

    /**
     * A unit of length equal to <code>1852.0 m</code>
     * (standard name <code>nmi</code>).
     */
    public static final Unit<Length> NAUTICAL_MILE = nonSI(METER.times(1852));

    /**
     * A unit of length equal to <code>1E-10 m</code>
     * (standard name <code>Å</code>).
     */
    public static final Unit<Length> ANGSTROM = nonSI(METER.divide(10000000000L));
     ...
     */
    public static final Unit<Length> ASTRONOMICAL_UNIT = nonSI(METER
     ...
     */
    public static final Unit<Length> LIGHT_YEAR = nonSI(METER.times(9.460528405e15));
     ...
     */
    public static final Unit<Length> PARSEC = nonSI(METER.times(30856770e9));
    ...
    public static final Unit<Velocity> KNOT 
        = nonSI(NAUTICAL_MILE.divide(HOUR).sameTypeAs(METER_PER_SECOND));

    /**
     * A unit of velocity to express the speed of an aircraft relative to
     * the speed of sound (standard name <code>Mach</code>).
     */
    public static final Unit<Velocity> MACH = nonSI(METER_PER_SECOND.times(331.6));

    /**
     * A unit of velocity relative to the speed of light
     * (standard name <code>c</code>).
     */
    public static final Unit<Velocity> C = nonSI(METER_PER_SECOND.times(299792458));
     ...
     */
    public static final Unit<Volume> LITER = nonSI(CUBIC_METER.divide(1000));

    /**
     * A unit of volume equal to one cubic inch (<code>in³</code>).
     */
    public static final Unit<Volume> CUBIC_INCH = nonSI(
            INCH.pow(3).sameTypeAs(SI.CUBIC_METER));
     ...
     */
    public static final Unit<Volume> GALLON_UK = nonSI(LITER.times(454609).divide(100000));
    ...
    public static final Unit<DynamicViscosity> 
         POISE = nonSI((Unit<DynamicViscosity>) GRAM.divide(CENTI(METER).times(SECOND)));
    ...
    public static final Unit<KinematicViscosity> 
         STOKE = nonSI((Unit<KinematicViscosity>) CENTI(METER).pow(2).divide(SECOND));
