...
public final class SI {
	...
	public static final BaseUnit<ElectricCurrent> AMPERE = new BaseUnit<ElectricCurrent>(
			"A", Dimension.ELECTRIC_CURRENT, Converter.IDENTITY);
	...
	public static final BaseUnit<LuminousIntensity> CANDELA = new BaseUnit<LuminousIntensity>(
			"cd", Dimension.LUMINOUS_INTENSITY, Converter.IDENTITY);
	...
	public static final BaseUnit<Temperature> KELVIN = new BaseUnit<Temperature>(
			"K", Dimension.TEMPERATURE, Converter.IDENTITY);
	...
	public static final BaseUnit<Mass> KILOGRAM = new BaseUnit<Mass>("kg",
			Dimension.MASS, Converter.IDENTITY);
	...
	public static final BaseUnit<Length> METER = new BaseUnit<Length>("m",
			Dimension.LENGTH, Converter.IDENTITY);
	...
	public static final BaseUnit<AmountOfSubstance> MOLE = new BaseUnit<AmountOfSubstance>(
			"mol", Dimension.AMOUNT_OF_SUBSTANCE, Converter.IDENTITY);
	...
	public static final BaseUnit<Duration> SECOND = new BaseUnit<Duration>("s",
			Dimension.TIME, Converter.IDENTITY);
	 ...
	 */
	public static final Unit<Angle> RADIAN = Unit.ONE.alternate("rad");
	 ...
	 */
	public static final Unit<SolidAngle> STERADIAN = Unit.ONE.alternate("sr");

	/**
	 * The unit for binary information (<code>bit</code>).
	 */
	public static final Unit<DataAmount> BIT = Unit.ONE.alternate("bit");
	 ...
	 */
	public static final Unit<Frequency> HERTZ = Unit.ONE.divide(SECOND)
			.alternate("Hz");
	 ...
	 */
	public static final Unit<Force> NEWTON = METER.times(KILOGRAM).divide(
	 ...
	 */
	public static final Unit<Pressure> PASCAL = NEWTON.divide(METER.pow(2))
			.alternate("Pa");
	 ...
	 */
	public static final Unit<Energy> JOULE = NEWTON.times(METER).alternate("J");
	 ...
	 */
	public static final Unit<ElectricCharge> COULOMB = SECOND.times(AMPERE)
			.alternate("C");
	 ...
	 */
	public static final Unit<MagneticFlux> WEBER = VOLT.times(SECOND)
			.alternate("Wb");
	 ...
	 */
	public static final Unit<LuminousFlux> LUMEN = CANDELA.times(STERADIAN)
			.alternate("lm");
	 ...
	 */
	public static final Unit<Illuminance> LUX = LUMEN.divide(METER.pow(2))
			.alternate("lx");
	 ...
	 * (1852-1908).
	 */
	public static final Unit<RadioactiveActivity> BECQUEREL = Unit.ONE.divide(
			SECOND).alternate("Bq");
	 ...
	 */
	public static final Unit<Velocity> METER_PER_SECOND = METER.divide(SECOND);

	/**
	 * The metric unit for acceleration quantities (<code>m/s²</code>).
	 */
	public static final Unit<Acceleration> METER_PER_SQUARE_SECOND = METER
			.divide(SECOND.pow(2));

	/**
	 * The metric unit for area quantities (<code>m²</code>).
	 */
	public static final Unit<Area> SQUARE_METER = METER.pow(2);

	/**
	 * The metric unit for volume quantities (<code>m³</code>).
	 */
	public static final Unit<Volume> CUBIC_METER = METER.pow(3);
	...
	static {
		for (int i = 0; i < SI_UNITS.length; i++) {
			for (int j = 0; j < PREFIXES.length; j++) {
				Unit u = SI_UNITS[i].times(FACTORS[j]);
		...
		SI.CELSIUS.label("°C");
		for (int i = 0; i < PREFIXES.length; i++) {
			SI.CELSIUS.times(FACTORS[i]).label(PREFIXES[i] + "°C");
		}
	}
