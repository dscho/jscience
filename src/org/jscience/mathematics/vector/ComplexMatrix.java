...
public final class ComplexMatrix extends Matrix<Complex> {
    ...
    private static void multiply(FastTable<ComplexVector> rows,
            Matrix<Complex> that, Index startColumn, Index endColumn,
    ...
    private static ConcurrentContext.Logic MULTIPLY = new ConcurrentContext.Logic() {
        ...
        public void run() {
            FastTable<ComplexVector> rows = getArgument(0);
