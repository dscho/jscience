 ...
 *     by adding single elements sparse vectors together. For example:[code]
...
public final class SparseVector<F extends Field<F>> extends Vector<F> {
    ...
    public boolean move(ObjectSpace os) {
        if (super.move(os)) {
            // The elements map itself is intrinsic (all final members are)
    ...
    private static Factory<SparseVector> FACTORY = new Factory<SparseVector>() {
        @Override
