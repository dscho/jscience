 ...
 */
public abstract class Function<X, Y> extends RealtimeObject implements
    ...
    public Function<X, Y> minus(Function<X, Y> that) {
        if (that instanceof GroupAdditive) {
            Function<X, Y> thatOpposite = ((GroupAdditive<Function<X, Y>>) that)
                    .opposite();
    ...
    public Function<X, Y> divide(Function<X, Y> that) {
        if (that instanceof GroupMultiplicative) {
            Function<X, Y> thatInverse = ((GroupMultiplicative<Function<X, Y>>) that)
                    .inverse();
    ...
    private static final class Derivative extends Function {
        ...
        private static final Factory<Derivative> FACTORY = new Factory<Derivative>() {
    ...
    private static final class Integral extends Function {
        ...
        private static final Factory<Integral> FACTORY = new Factory<Integral>() {
    ...
    private static final class Minus extends Function {
        ...
        private static final Factory<Minus> FACTORY = new Factory<Minus>() {
    ...
    private static final class Divide extends Function {
        ...
        private static final Factory<Divide> FACTORY = new Factory<Divide>() {
